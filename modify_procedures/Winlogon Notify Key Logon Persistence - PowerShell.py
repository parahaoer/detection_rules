...
with open("dst_procedures/Winlogon Notify Key Logon Persistence - PowerShell.py", "w", encoding="gbk") as f:
	f.write(json_str+"\n")
	f.write('tactic = "Persistence"\n')
	f.write('technique = "Winlogon Helper DLL"\n')
	f.write('procedure = "Winlogon Notify Key Logon Persistence - PowerShell"\n')
