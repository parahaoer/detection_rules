...
with open("dst_procedures/Create Windows System File with Attrib.py", "w", encoding="gbk") as f:
	f.write(json_str+"\n")
	f.write('tactic = "Persistence"\n')
	f.write('technique = "Hidden Files and Directories"\n')
	f.write('procedure = "Create Windows System File with Attrib"\n')
	f.write('tech_code = "T1158"\n')
