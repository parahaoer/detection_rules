...
with open("dst_procedures/Rundll32 execute JavaScript Remote Payload With GetObject.py", "w", encoding="gbk") as f:
	f.write(json_str+"\n")
	f.write('tactic = "Execution"\n')
	f.write('technique = "Rundll32"\n')
	f.write('procedure = "Rundll32 execute JavaScript Remote Payload With GetObject"\n')
	f.write('tech_code = "T1085"\n')
