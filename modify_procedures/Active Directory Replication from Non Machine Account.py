...
with open("dst_procedures/Active Directory Replication from Non Machine Account.py", "w", encoding="gbk") as f:
	f.write(json_str+"\n")
	f.write('tactic = "Credential Access"\n')
	f.write('technique = "Credential Dumping"\n')
	f.write('procedure = "Active Directory Replication from Non Machine Account"\n')
